  ...
  return (
    <>
      <Container marginTop="30">
        ...
        <HeroSection className="animate__animated animate__fadeIn animate__infinite animate__slower">
          <Box>
            ...
            <Typography variant="h6">
              Find what you need at unbeatable prices
            </Typography>
          </Box>
        </HeroSection>
        ...
        {/* Special Offers */}
        <Box
          className="animate__animated animate__pulse  animate__slower"
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <Typography variant="h6" color="">
                    Don’t miss out on these exclusive discounts! Upto 30%OFF on
                    Products below 30000
                  </Typography>
                  <Button
                    href="/categories/below30"
                    variant="contained"
            ...
            <Grid item xs={12} md={6}>
              <Card>
                ...
                <CardContent>
                  <Typography variant="h5"></Typography>
                  <Typography variant="h6" color="">
                    Don’t miss out on these exclusive discounts! Upto 10%OFF on
          ...
          <Grid container spacing={4} style={{ marginTop: 20 }}>
            <Grid item xs={12} md={6}>
              <TestimonialCard>
                ...
                <Typography variant="body2" color="textSecondary">
                  "This is the best e-commerce site I've ever used. The products
            ...
            <Grid item xs={12} md={6}>
              <TestimonialCard>
                ...
                <Typography variant="body2" color="textSecondary">
                  "I had a fantastic shopping experience. Fast delivery and
